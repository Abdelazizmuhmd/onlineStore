...
<div class="grid">
  ...
  <div class="grid__item">
    ...
    <div id="CustomerLoginForm" class="form-vertical">
      <form method="post" action="loginBackend.php" id="customer_login" accept-charset="UTF-8"><input type="hidden" name="form_type" value="customer_login"><input type="hidden" name="utf8" value="✓">
