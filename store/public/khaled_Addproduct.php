    ...
    <div class="grid__item  medium-up--two-fifths  small--one-half text-right">
      <a href="" class="site-header__cart">
        ...
        <span class="small--hide">
          Cart
          (<span id="CartCount"><?php //if(isset($_COOKIE['cartNumbers'])){
            echo $_COOKIE['cartNumbers'];
  ...
  @media screen and (min-width: 750px) { 
    ...
    @media screen and (max-width: 749px) {
      ...
      #ProductImageWrapper-13801390768162 {
        ...
        <div id="ProductImageWrapper-13801390768162" class="product-single__featured-image-wrapper supports-js" >


          <div class="product-single__photos" data-aspectratio="1.0"  style="padding-top: 100%; position: relative; overflow: hidden;">
              
           <img  id="product_image" class="product-single__photo"  src="../images/c.jpg" data-widths="[180, 360, 470, 600, 750, 940, 1080, 1296, 1512, 1728, 2048]" data-aspectratio="1.0">
           <input type="text" name="product_image1" id="product_image1" value="../images/c.jpg" hidden>
      ...
      <div class="product-single__meta small--text-center">
        ...
        <div >
          ...
          <p class="product-single__prices">
            ...
            <input type="text" name="product_price1" id="product_price1" value="30.0" hidden>
            <input type="text" name="product_id" id="product_id" value="1" hidden>
            ...
            <div class="selector-wrapper">
                ...
                <select class="single-option-selector" name="color" data-option="option1" id="ProductSelect-product-template-option-0">
                ...
                <div class="selector-wrapper">
                    ...
                    <select class="single-option-selector" name="size" data-option="option2" id="ProductSelect-product-template-option-1">
          ...
          <div class="product-single__cart-submit-wrapper  product-form--full">
             ...
             <div class="product-single__cart-submit-wrapper  product-form--full">
              <button type="submit" name="buy" id="AddToCart" class="btn product-single__cart-submit btn--full " >
...
<div class="social-sharing" data-permalink="">
    ...
    <a target="_blank" href="" class="social-sharing__link" title="Share on Facebook">
    ...
    <a target="_blank" href="" class="social-sharing__link" title="Tweet on Twitter">
